...
If it will actually work (haven't tested it yet), then I have added:
...
Don't know, if I will get it to run I will update this README again.
Till then, I will continue blindly writing code for atmux.
